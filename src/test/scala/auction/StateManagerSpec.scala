...
//      expectMsg(GetParticipants)
//      expectMsg(1.seconds,FreezeEntry)
//      expectMsg(3.seconds,StartAuction(Price(3)))
//      b ! PoisonPill
//    }
...
//      expectMsg(1.seconds,FreezeEntry)
//      expectMsg(3.seconds,StartAuction(Price(3)))
//      expectMsg(3.seconds,PriceChange(Price(2)))
//      expectMsg(3.seconds,PriceChange(Price(1)))
...
//      expectMsg(GetParticipants)
//      expectMsg(1.seconds,FreezeEntry)
//      expectMsg(1.seconds,StartAuction(Price(3)))
//      expectMsg(1.seconds,PriceChange(Price(2)))
//      expectMsg(1.seconds,PriceChange(Price(1)))
