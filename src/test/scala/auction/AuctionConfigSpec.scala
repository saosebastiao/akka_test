...
//      val config = AuctionConfig(start,Duration.ofMinutes(1),1,Price(10))
...
//      val config = AuctionConfig(start,Duration.ofMinutes(1),1,Price(3))
